...
import com.test.gateway.common.Result;
...
public class GateWayExceptionHandlerAdvice {
	...
	public Result handle(BadCredentialsException ex) {
		log.error("badCredentialsException exception:{}", ex.getMessage());
		ex.printStackTrace();
	...
	public Result handle(Throwable throwable) {
		...
		if (throwable instanceof ResponseStatusException) {
			...
			result = handle((BadCredentialsException) throwable);
