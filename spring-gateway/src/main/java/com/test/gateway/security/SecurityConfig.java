...
public class SecurityConfig {
	...
	private static final String[] AUTH_WHITELIST = new String[]{"/login", "/actuator/**", "/ucenter-web/login"};
...
//		authenticationWebFilter.setAuthenticationFailureHandler((webFilterExchange, exception) -> Mono.error(new BadCredentialsException("登录超时或登录认证失效!")));
