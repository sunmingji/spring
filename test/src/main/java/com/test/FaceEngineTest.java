...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "56fX3t4bJjVQXFX9gaRdXH69hL6cYzzbmiZDHhUuwWMn";
        String sdkKey = "H3EKLuXp5FKCoKm8nX2g2X78oyvw3UiR5QRkHgtDXWUK";

        //获取路径
        URL resource = Void.class.getResource("/");
        String path = resource.getPath() + "so/";
